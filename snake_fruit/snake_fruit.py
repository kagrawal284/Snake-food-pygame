...
class Food:
    ...
    def draw(self):
        food_rect = pygame.Rect(
            OFFSET+self.position.x * cell_size, OFFSET+self.position.y * cell_size, cell_size, cell_size)
...
game = Game()
food_surface = pygame.image.load("snake_fruit/food.png")
...
while True:
    ...
    score_surface = score_font.render((f"Score:{str(game.score)}"), True, DARK_GREEN)
